...
-- Upload: diii  →  first("test-stepseq-swing-drum.lua")
-- =========================================================
...
local _drum_divs = {[0]=4}
local _drum_swing = {[0]=2}
...
local function _drum_tick()
  ...
  for r = 0, 0 do
    ...
    if state.drum_tick[r] <= 0 then
      ...
      state.drum_tick[r] = _drum_divs[r] + ((state.drum_step[r] % 2 == 0) and _drum_swing[r] or -_drum_swing[r])
...
local _drum_metro = metro.init(_drum_tick, 0.03125)
_drum_metro:start()
