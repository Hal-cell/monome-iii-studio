...
local function _draw_p0()
  -- region: keys
  grid_led(1, 5, state.keys_held[1 + 5*W] and 12 or 0)
  grid_led(2, 5, state.keys_held[2 + 5*W] and 12 or 3)
  grid_led(3, 5, state.keys_held[3 + 5*W] and 12 or 3)
  grid_led(4, 5, state.keys_held[4 + 5*W] and 12 or 0)
  grid_led(1, 6, state.keys_held[1 + 6*W] and 12 or 0)
  grid_led(2, 6, state.keys_held[2 + 6*W] and 12 or 3)
  grid_led(3, 6, state.keys_held[3 + 6*W] and 12 or 6)
  grid_led(4, 6, state.keys_held[4 + 6*W] and 12 or 0)
  grid_led(1, 7, state.keys_held[1 + 7*W] and 12 or 3)
  grid_led(2, 7, state.keys_held[2 + 7*W] and 12 or 0)
  grid_led(3, 7, state.keys_held[3 + 7*W] and 12 or 3)
  grid_led(4, 7, state.keys_held[4 + 7*W] and 12 or 0)
  grid_led(1, 8, state.keys_held[1 + 8*W] and 12 or 6)
  grid_led(2, 8, state.keys_held[2 + 8*W] and 12 or 0)
  grid_led(3, 8, state.keys_held[3 + 8*W] and 12 or 3)
  grid_led(4, 8, state.keys_held[4 + 8*W] and 12 or 0)
end
